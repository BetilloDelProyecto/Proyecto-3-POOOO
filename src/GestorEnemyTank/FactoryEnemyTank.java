...
public class FactoryEnemyTank implements EnemyTankFactoryMethod{
    ...
    public EnemyTank createEnemyTank(String tipo, int posX, int posY,int velocidadMovimiento,int velocidadDisparo) {
        switch(tipo){
            case "simple":
                EnemyTank t1 = new EnemyTank(2,posX,posY,velocidadMovimiento,velocidadDisparo, tipo);
                ...
                return t1;
            case "rapido":
                EnemyTank t2 = new EnemyTank(1,posX,posY,velocidadMovimiento,velocidadDisparo, tipo);
                ...
                return t2;
            case "fuerte":
                EnemyTank t3 = new EnemyTank(1,posX,posY,velocidadMovimiento,velocidadDisparo, tipo);
                ...
                return t3;
            case "resistente":
                EnemyTank t4 = new EnemyTank(4,posX,posY,velocidadMovimiento,velocidadDisparo, tipo);
